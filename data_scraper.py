...
scan_button.grid(row=5, column=0, padx=10, pady=10)
...
add_files_button.grid(row=6, column=0, columnspan=2, padx=10, pady=10)
...
execute_operation_button.grid(row=7, column=0, columnspan=2, padx=10, pady=10)
...
debug_button = tk.Button(root, text="Toggle Debug Window", 
                        ...
                        bg="#2d2d2d", fg="white", relief="flat")
debug_button.grid(row=8, column=0, columnspan=2, padx=10, pady=10)
